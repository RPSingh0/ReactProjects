...
export default function App() {
    ...
    function handleAddFriend(friend) {
        // we don't want to mutate original array..., just create and return original array
...
function FriendsList({friends, selectedFriend, onSelection}) {
    ...
    return (
        <ul>
            {friends.map(friend => <Friend friend={friend} key={friend.id} onSelection={onSelection}
